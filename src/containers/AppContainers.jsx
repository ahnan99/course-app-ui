...
import qs from 'qs'
const _host = qs.parse(this.props.location.search, { ignoreQueryPrefix: true }).host || "";
const _fromID = qs.parse(this.props.location.search, { ignoreQueryPrefix: true }).fromID || "";
